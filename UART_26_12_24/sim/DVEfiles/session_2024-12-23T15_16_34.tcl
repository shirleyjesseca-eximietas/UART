...
# DVE full session
# Saved on Mon Dec 23 15:16:34 2024
# Designs open: 1
#   V1: /home/shirley/GIT_CHECKOUT/UART/UART_non_pulpino/sim/uart_new.vpd
...
#<Session mode="Full" path="/home/shirley/GIT_CHECKOUT/UART/UART_non_pulpino/sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{1 38} {1920 1048}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 247} {height 830} {dock_state left} {dock_on_new_line true} {child_hier_colhier 230} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 348]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 348
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 830
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 347} {height 830} {dock_state left} {dock_on_new_line true} {child_data_colvariable 179} {child_data_colvalue 134} {child_data_coltype 125} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
if { ![gui_is_db_opened -db {/home/shirley/GIT_CHECKOUT/UART/UART_non_pulpino/sim/uart_new.vpd}] } {
	gui_open_db -design V1 -file /home/shirley/GIT_CHECKOUT/UART/UART_non_pulpino/sim/uart_new.vpd -nosource
}
...
gui_open_source -id ${Source.1}  -replace -active top /home/shirley/GIT_CHECKOUT/UART/UART_non_pulpino/sim/../verif/env/top.sv
